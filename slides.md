...
info: |
  ...
  Compatibility deck containing every section source. Sections are imported from the shared section library.
layout: cover
---
...
Content superset — Compatibility deck containing every section source.
