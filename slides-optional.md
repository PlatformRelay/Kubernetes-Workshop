...
info: |
  ...
  Rampa de entrada, seções extras e material avançado. As seções são importadas da biblioteca de seções compartilhada.
layout: cover
---
...
Optional / Appendix — Rampa de entrada, seções extras e material avançado.
